...
class LoggenClass:
    ...
    def log_generator():
        ...
        logfile = logging.FileHandler("D:\\Credence_17_Notes\\Automation Testing Part 2 by Tushar sir\\Class 10 Notest nopcomm project\\class 6 nopcom_pytest\\Logs\\NopCom_Logs.log'")  # log file
